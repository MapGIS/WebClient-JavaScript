...
/*
 * L.Control.TimeDimensionControl: Leaflet control to manage a timeDimension
 */
L.UI = L.ui = L.UI || {};
 ...
 * L.Control.TimeDimensionControl: Leaflet control to manage a timeDimension
 */
export var TimeDimensionControl = L.Control.extend({
    options: {
    ...
    _initPlayer: function() {
        if (!this._player){ // in case of remove/add
            if (this.options.player) {
                ...
                this._player = new TimeDimensionPlayer(this.options.playerOptions, this._timeDimension);
            }
        }
...
export var timeDimension = function(options) {
    return new TimeDimensionControl(options);
};

L.zondy.TimeDimensionControl = timeDimension;