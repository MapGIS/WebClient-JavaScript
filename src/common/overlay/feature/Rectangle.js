 ...
 *
 * @typedef {Object} Zondy.Feature.ShapeParameters.Rectangle.style
 ...
 */
class Rectangle extends ShapeParameters {

    /**
     * @function Zondy.Feature.ShapeParameters.Rectangle.prototype.constructor
     ...
     * @returns {Zondy.Feature.ShapeParameters.Rectangle} 图形矩形参数对象。
     */
    constructor(x, y, width, height) {
        super(x, y, width, height);

        /**
         * @member {number} Zondy.Feature.ShapeParameters.Rectangle.prototype.x
         * @description 左上角 x 坐标。
         */
        this.x = !isNaN(x) ? x : 0;

        /**
         * @member {number} Zondy.Feature.ShapeParameters.Rectangle.prototype.y
         * @description 左上角 y 坐标。
         */
        this.y = !isNaN(x) ? y : 0;

        /**
         * @member {number} Zondy.Feature.ShapeParameters.Rectangle.prototype.width
         * @description 宽度。
         */
        this.width = !isNaN(width) ? width : 0;

        /**
         * @member {number} Zondy.Feature.ShapeParameters.Rectangle.prototype.height
         * @description 高度。
         */
        this.height = !isNaN(height) ? height : 0;

        this.CLASS_NAME = "Zondy.Feature.ShapeParameters.Rectangle";
    }
    
    /**
     * @function Zondy.Feature.ShapeParameters.Rectangle.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.x = null;
...
export {Rectangle};
Zondy.Feature.ShapeParameters.Rectangle = Rectangle;