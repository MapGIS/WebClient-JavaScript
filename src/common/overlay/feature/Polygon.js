 ...
 *
 * @typedef {Object} Zondy.Feature.ShapeParameters.Polygon.style
 ...
 */
class Polygon extends ShapeParameters {

    /**
     * @function Zondy.Feature.ShapeParameters.Polygon.prototype.constructor
     * @description 创建一个图形面参数对象。
     * @param {Array} pointList - 横坐标，必设参数。
     * @returns {Zondy.Feature.ShapeParameters.Polygon} 标签参数对象。
     */
    constructor(pointList) {
        super(pointList);

        /**
         * @member {Array} Zondy.Feature.ShapeParameters.Polygon.prototype.pointList
        ...
        /**
         * @member {Array} Zondy.Feature.ShapeParameters.Polygon.prototype.holePolygonPointLists
         * @description 岛洞面多边形顶点数组（三维数组）
         */
        this.holePolygonPointLists = null;

        this.CLASS_NAME = "Zondy.Feature.ShapeParameters.Polygon";
    }

    /**
     * @function Zondy.Feature.ShapeParameters.Polygon.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.pointList = null;
...
export {Polygon};
Zondy.Feature.ShapeParameters.Polygon = Polygon;