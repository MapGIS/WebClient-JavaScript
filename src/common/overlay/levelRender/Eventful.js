...
class Eventful {
    ...
    /**
     * @function Zondy.LevelRenderer.Eventful.prototype.constructor
    ...
    constructor() {
        /**
         * @member {Object} Zondy.LevelRenderer.Eventful.prototype._handlers
    ...
    /**
     * @function {Object} Zondy.LevelRenderer.Eventful.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.Eventful.prototype.one
     * @description 单次触发绑定，dispatch后销毁。
     * @param {string} event - 事件名。
     * @param {boolean} handler - 响应函数。
     * @param {Object} context - context。
     * @returns {Zondy.LevelRenderer.Eventful} this
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Eventful.prototype.bind
     * @description 绑定事件。
     * @param {string} event - 事件名。
     * @param {boolean} handler - 响应函数。
     * @param {Object} context - context。
    ...
    /**
     * @function Zondy.LevelRenderer.Eventful.prototype.unbind
     * @description 解绑事件。
     * @param {string} event - 事件名。
     * @param {boolean} handler - 响应函数。
     * @returns {Zondy.LevelRenderer.Eventful} this
    ...
    /**
     * @function Zondy.LevelRenderer.Eventful.prototype.dispatch
     * @description 事件分发。
    ...
    /**
     * @function Zondy.LevelRenderer.Eventful.prototype.dispatchWithContext
...
export {Eventful};
Zondy.LevelRenderer.Eventful = Eventful;