...
class Matrix {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.constructor
     * @description 构造函数。
     */
    constructor() {
        /**
         * @member {Object} Zondy.LevelRenderer.Tool.Matrix.prototype.ArrayCtor
         * @description 数组类型控制
         */
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.create
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.identity
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.copy
     * @description 复制矩阵。
     * @param {(Float32Array|Array.<number>)} out - 单位矩阵。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.mul
     * @description 矩阵相乘。
     * @param {(Float32Array|Array.<number>)} out - 单位矩阵。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.rotate
     * @description 平移变换。
     * @param {(Float32Array|Array.<number>)} out - 单位矩阵。
     * @param {(Float32Array|Array.<number>)} a - 矩阵。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.scale
     * @description 缩放变换。
     * @param {(Float32Array|Array.<number>)} out - 单位矩阵。
     * @param {(Float32Array|Array.<number>)} a - 矩阵。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.invert
     * @description 求逆矩阵。
     * @param {(Float32Array|Array.<number>)} out - 单位矩阵。
     * @param {(Float32Array|Array.<number>)} a - 矩阵。
     * @returns {(Float32Array|Array.<number>)} 结果矩阵。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Matrix.prototype.mulVector
     * @description 矩阵左乘向量。
     * @param {(Float32Array|Array.<number>)} out - 单位矩阵。
     * @param {(Float32Array|Array.<number>)} a - 矩阵。
     * @param {(Float32Array|Array.<number>)} v - 缩放参数。
...
export {Matrix};
Zondy.LevelRenderer.Tool.Matrix = Matrix;