...
/**
 * @private
 * @class  Zondy.LevelRenderer.SmicCircle
 * @classdesc 圆形
 ...
 */
class SmicCircle extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicCircle.prototype.style
     * @description 绘制样式。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicCircle.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicCircle.prototype.type
         * @description 图形类型。
         */
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.SmicCircle";
    }

    /**
     * @function Zondy.LevelRenderer.SmicCircle.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicCircle.prototype.buildPath
     * @description 创建图形路径。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicCircle.prototype.getRect
...
export {SmicCircle};
Zondy.LevelRenderer.SmicCircle = SmicCircle;