...
/**
 * @private
 * @class  Zondy.LevelRenderer.SmicRing
 * @classdesc 圆环。
 * @extends Zondy.LevelRenderer.Shape
 * @example
 *   var shape = new Zondy.LevelRenderer.SmicRing({
 *         style: {
 *             x: 100,
 *             y: 100,
 *             r0: 30,
 ...
 */
class SmicRing extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicRing.prototype.style
     * @description 绘制样式。
     *
     ...
     */
    /**
     * @function Zondy.LevelRenderer.SmicRing.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicRing.prototype.type
         * @description 图形类型。
         */
        this.type = 'smicring';
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape.SmicRing";
    }

    /**
     * @function Zondy.LevelRenderer.SmicRing.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicRing.prototype.buildPath
     * @description 创建圆环路径。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicRing.prototype.getRect
...
export {SmicRing};
Zondy.LevelRenderer.SmicRing = SmicRing;