 ...
 */
class SmicIsogon extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicIsogon.prototype.style
     * @description 绘制样式。
     *
     ...
     */
    /**
     * @function Zondy.LevelRenderer.SmicIsogon.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicIsogon.prototype.type
         * @description 图形类型。
         */
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.SmicIsogon";
    }


    /**
     * @function Zondy.LevelRenderer.SmicIsogon.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicIsogon.prototype.buildPath
    ...
    /**
     * @function Zondy.LevelRenderer.SmicIsogon.prototype.getRect
...
export {SmicIsogon};
Zondy.LevelRenderer.SmicIsogon = SmicIsogon;