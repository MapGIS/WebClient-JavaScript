...
class Handler extends Eventful {
    ...
    /**
     * @function Zondy.LevelRenderer.Handler.constructor
     * @description 构造函数。
    ...
    constructor(root, storage, painter) {
        ...
        /**
         * @member {HTMLElement} Zondy.LevelRenderer.Handler.prototype.root
         * @description 绘图区域
         */
        this.root = root;
        /**
         * @member {Zondy.LevelRenderer.Storage} Zondy.LevelRenderer.Handler.prototype.storage
         * @description Storage 实例
         */
        this.storage = storage;
        /**
         * @member {Zondy.LevelRenderer.Painter} Zondy.LevelRenderer.Handler.prototype.Painter
         * @description Painter 实例
         */
        this.painter = painter;
        /**
         * @member {number} [Zondy.LevelRenderer.Handler.prototype._lastX=0]
         * @description 上一次鼠标位置x坐标值
         */
        this._lastX = 0;
        /**
         * @member {number} [Zondy.LevelRenderer.Handler.prototype._lastY=0]
         * @description 上一次鼠标位置y坐标值
         */
        this._lastY = 0;
        /**
         * @member {number} [Zondy.LevelRenderer.Handler.prototype._mouseX=0]
         * @description 当前鼠标位置x坐标值
         */
        this._mouseX = 0;
        /**
         * @member {number} [Zondy.LevelRenderer.Handler.prototype._mouseY=0]
         * @description 当前鼠标位置y坐标值
         */
        this._mouseY = 0;
        /**
         * @member {Function} Zondy.LevelRenderer.Handler.prototype._findHover
         * @description 查找 Hover 图形
         */
        this._findHover = null;
        /**
         * @member {Object} Zondy.LevelRenderer.Handler.prototype._domHover
         * @description 高亮 DOM
         */
        this._domHover = null;
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Handler";
        var domHandlers = {
            /**
             * Method: resize
             * 窗口大小改变响应函数。
    ...
    /**
     * @function Zondy.LevelRenderer.Handler.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.Handler.prototype.on
     * @description 自定义事件绑定。
     * @param {string} eventName - 事件名称，resize、hover、drag等。
     * @param {function} handler - 响应函数。
     * @returns {Zondy.LevelRenderer.Handler} this。
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Handler.prototype.un
    ...
    /**
     * @function Zondy.LevelRenderer.Handler.prototype.trigger
     * @description 事件触发。
     * @param {string} eventName - 事件名称，resize、hover、drag等。
    ...
    /**
     * @function Zondy.LevelRenderer.Handler.prototype.dispose
    ...
    // SMIC-方法扩展 - start
    /**
     * @function Zondy.LevelRenderer.Handler.prototype.getLastHoverOne
...
export {Handler};
Zondy.LevelRenderer.Handler = Handler;