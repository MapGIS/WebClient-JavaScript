...
/**
 * @private
 * @class  Zondy.LevelRenderer.SmicImage
 * @classdesc 图片绘制。
 * @extends Zondy.LevelRenderer.Shape
 * @example
 *   var shape = new Zondy.LevelRenderer.SmicImage({
 *         style: {
 *             image: 'test.jpg',
 *             x: 100,
 *             y: 100
 ...
 */
class SmicImage extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicImage.prototype.style
     * @description 绘制样式。
     *
     ...
     */
    /**
     * @function Zondy.LevelRenderer.SmicImage.constructor
     * @description 构造函数。
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicImage.prototype.type
         * @description  图形类型。
         */
        this.type = 'smicimage';

        /**
         * @member {string} Zondy.LevelRenderer.SmicImage.prototype._imageCache
         * @description 图片缓存。
         */
        this._imageCache = {};
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape.SmicImage";
    }

    /**
     * @function Zondy.LevelRenderer.SmicImage.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicImage.prototype.buildPath
     * @description 创建图片。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicImage.prototype.getRect
    ...
    /**
     * @function Zondy.LevelRenderer.SmicImage.prototype.clearCache
     * @description 清除图片缓存。
     *
     * @param {Object} style - style
     * @return {Object} 边框对象。包含属性：x，y，width，height。
...
export {SmicImage};
Zondy.LevelRenderer.SmicImage = SmicImage;