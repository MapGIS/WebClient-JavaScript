...
class Curve {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.constructor
     * @description 构造函数。
     */
    constructor() {
        /**
         * @member {Zondy.LevelRenderer.Tool.Vector} Zondy.LevelRenderer.Tool.Curve.prototype.vector
         * @description 矢量工具。
         */
        this.vector = new LevelRendererVector();

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Curve.prototype.EPSILON
         * @description e。
         */
        this.EPSILON = 1e-4;

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Curve.prototype.THREE_SQRT
         * @description 3 的平方根。
         */
        this.THREE_SQRT = Math.sqrt(3);

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Curve.prototype.ONE_THIRD
         * @description 1/3。
         */
        this.ONE_THIRD = 1 / 3;
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.isAroundZero
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.isNotAroundZero
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.cubicAt
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.cubicDerivativeAt
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.cubicRootAt
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.cubicSubdivide
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.cubicProjectPoint
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.quadraticAt
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.quadraticRootAt
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.quadraticExtremum
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Curve.prototype.quadraticProjectPoint
...
export {Curve};
Zondy.LevelRenderer.Tool.Curve = Curve;