...
class Color {
    constructor() {
        /**
         * @member {Zondy.LevelRenderer.Tool.Util} Zondy.LevelRenderer.Tool.Color.prototype.util
         * @description LevelRenderer 基础工具对象。
         */
        this.util = new Util();

        /**
         * @member {Object} Zondy.LevelRenderer.Tool.Color.prototype._ctx
         * @description _ctx。
         */
        this._ctx = null;

        /**
         * @member {Array} Zondy.LevelRenderer.Tool.Color.prototype.palette
        ...
        /**
         * @member {Array} Zondy.LevelRenderer.Tool.Color.prototype._palette
         * @description 复位色板，用于复位  palette
         */
        this._palette = this.palette;

        /**
         * @member {string} Zondy.LevelRenderer.Tool.Color.prototype.highlightColor
         * @description 高亮色
         */
        this.highlightColor = 'rgba(0,0,255,1)';

        /**
         * @member {string} Zondy.LevelRenderer.Tool.Color.prototype._highlightColor
         * @description 复位高亮色
         */
        this._highlightColor = this.highlightColor;

        /**
         * @member {string} Zondy.LevelRenderer.Tool.Color.prototype.colorRegExp
        ...
        /**
         * @member {string} Zondy.LevelRenderer.Tool.Color.prototype._nameColors
         * @description 颜色名。
         */
        this._nameColors = {
            aliceblue: '#f0f8ff',
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.customPalette
     * @description 自定义调色板。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.resetPalette
     * @description 复位默认色板。
     */
    resetPalette() {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getColor
     * @description 获取色板颜色。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.customHighlight
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.resetHighlight
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getHighlightColor
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getRadialGradient
     * @description 径向渐变。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getLinearGradient
     * @description 线性渐变。
     * @param {number} x0 - 渐变起点横坐标。
     * @param {number} y0 - 渐变起点纵坐标。
     * @param {number} x1 - 渐变终点横坐标。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getStepColors
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getGradientColors
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toColor
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toArray
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.convert
     * @description 颜色格式转化。
     * @param {Array} data - 颜色值数组。
     * @param {string} format - 格式，默认'rgb'
     * @returns {string} 颜色。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toRGBA
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toRGB
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHex
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHSVA
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHSV
     * @description 转换为HSV颜色。
     * @param {string} color - 颜色。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHSBA
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHSB
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHSLA
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toHSL
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.toName
     * @description 转换颜色名。
     * @param {string} color - 颜色。
     * @returns {string} 颜色名
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.trim
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.normalize
     * @description 颜色规范化。
     * @param {string} color - 颜色。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.lift
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.reverse
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.mix
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.random
     * @description 随机颜色
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.getData
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.alpha
     * @description 设置颜色透明度
     * @param {string} color - 颜色。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.map
     * @description 数组映射
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.adjust
     * @description 调整值区间
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype.isCalculableColor
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype._HSV_2_RGB。参见{@link http://www.easyrgb.com/index.php?X=MATH}
     */
    _HSV_2_RGB(data) {
        var H = data[0];
        var S = data[1];
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype._HSL_2_RGB。参见{@link http://www.easyrgb.com/index.php?X=MATH}
     */
    _HSL_2_RGB(data) {
        var H = data[0];
        var S = data[1];
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype._HUE_2_RGB。参见{@link http://www.easyrgb.com/index.php?X=MATH}
     */
    _HUE_2_RGB(v1, v2, vH) {
        if (vH < 0) {
            vH += 1;
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype._RGB_2_HSB。参见{@link http://www.easyrgb.com/index.php?X=MATH}
     */
    _RGB_2_HSB(data) {
        // RGB from 0 to 255
        var R = (data[0] / 255);
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Color.prototype._RGB_2_HSL。参见{@link http://www.easyrgb.com/index.php?X=MATH}
     */
    _RGB_2_HSL(data) {
...
export {Color};
Zondy.LevelRenderer.Tool.Color = Color;