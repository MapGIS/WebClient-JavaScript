 ...
 *
 */
class SmicText extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicText.prototype.style
     * @description 绘制样式。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicText.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicText.prototype.type
         * @description 图形类型.
         */
        this.type = 'smictext';
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.SmicText";
    }

    /**
     * @function Zondy.LevelRenderer.SmicText.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicText.prototype.brush
     * @description 笔触。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicText.prototype.getRect
    ...
    /**
     * @function Zondy.LevelRenderer.SmicText.prototype.getRectNoRotation
    ...
    /**
     * @function Zondy.LevelRenderer.SmicText.prototype.getTextBackground
    ...
    /**
     * @function Zondy.LevelRenderer.SmicText.prototype.getRotatedLocation
...
export {SmicText};
Zondy.LevelRenderer.SmicText = SmicText;