...
import {merge} from '../../service/common/Util';
...
class Storage {
    /**
     * @function Zondy.LevelRenderer.Storage.constructor
     * @description 构造函数。
     */
    constructor() {
        /**
         * @member {Object} Zondy.LevelRenderer.Storage.prototype._elements
         * @description 所有常规形状，id 索引的 map。
         */
        this._elements = {};

        /**
         * @member {Array} Zondy.LevelRenderer.Storage.prototype._hoverElements
        ...
        /**
         * @member {Array} Zondy.LevelRenderer.Storage.prototype._roots
         * @description _roots。
         *
         */
        this._roots = [];
        ...
        /**
         * @member {Array} Zondy.LevelRenderer.Storage.prototype._shapeList
        ...
        /**
         * @member {number} Zondy.LevelRenderer.Storage.prototype._shapeListOffset
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.iterShape
     * @description 遍历迭代器。
     *
     ...
     * @return {Zondy.LevelRenderer.Storage} this。
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.getHoverShapes
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.getShapeList
     * @description 返回所有图形的绘制队列。
     *
     * @param {boolean} [update=false] - 是否在返回前更新该数组。  详见：<Zondy.LevelRenderer.Shape> updateShapeList。
     * @return {Zondy.LevelRenderer.Shape} 图形。
     */
    getShapeList(update) {
        if (update) {
            this.updateShapeList();
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.updateShapeList
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype._updateAndAddShape
     * @description 更新并添加图形。
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.mod
        ...
        if (el) {
            ...
            if (params) {
                ...
                if (params.parent || params._storage || params.__startClip) {
                    ...
                    merge(el, target, true);
                } else {
                    merge(el, params, true);
                }
            }
        }
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.drift
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.addHover
     * @description 添加高亮层数据。
     * @param {Zondy.LevelRenderer.Shape} shape - 图形。
     * @return {Zondy.LevelRenderer.Storage} this。
     */
    addHover(shape) {
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.delHover
     * @description 清空高亮层数据。
     * @return {Zondy.LevelRenderer.Storage} this。
     */
    delHover() {
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.hasHoverShape
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.addRoot
     * @description 添加图形(Shape)或者组(Group)到根节点。
     *
     * @param {(Zondy.LevelRenderer.Shape/Zondy.LevelRenderer.Group)} el - 图形。
     *
     */
    addRoot(el) {
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.delRoot
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.addToMap
     * @description 添加图形到 map。
     *
     * @param {Zondy.LevelRenderer.Shape} el - 图形。
     * @return {Zondy.LevelRenderer.Storage} this。
     */
    addToMap(el) {
        if (el instanceof Group) {
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.get
     * @description 获取指定图形。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.delFromMap
    ...
    /**
     * @function Zondy.LevelRenderer.Storage.prototype.dispose
...
export {Storage};
Zondy.LevelRenderer.Storage = Storage;