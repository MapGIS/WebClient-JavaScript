...
/**
 * @private
 * @class  Zondy.LevelRenderer.SUtil
 */
class SUtil {
    /**
     * @function Zondy.LevelRenderer.SUtil.SUtil_smoothBezier
     * @description 贝塞尔平滑曲线。
     * @private
    ...
    /**
     * @function Zondy.LevelRenderer.SUtil.SUtil_smoothSpline
     * @description 插值折线。
     * @private
     * @param {Array} points - 线段顶点数组。
     * @param {boolean} isLoop - isLoop。
    ...
    /**
     * @function Zondy.LevelRenderer.SUtil.SUtil_dashedLineTo
...
SUtil.Util_curve = new LevelRendererCurve();
SUtil.Util_env = new Env();
SUtil.Util_event = new LevelRendererEvent();
SUtil.Util_http = new Http();
SUtil.Util_math = new SMath();
SUtil.Util_matrix = new Matrix();
SUtil.Util = new Util();
SUtil.Util_vector = new LevelRendererVector();

export {SUtil};
Zondy.LevelRenderer.SUtil = SUtil;
