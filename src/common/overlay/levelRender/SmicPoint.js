...
/**
 * @private
 * @class  Zondy.LevelRenderer.SmicPoint
 * @classdesc 点。
 * @extends Zondy.LevelRenderer.Shape
 * @example
 *   var shape = new Zondy.LevelRenderer.SmicPoint({
 *       style: {
 *           x: 100,
 *           y: 100,
 *           r: 40,
 ...
 *
 */
class SmicPoint extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicPoint.prototype.style
     * @description 绘制样式。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicPoint.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicPoint.prototype.type
         * @description 图形类型。
         */
        this.type = 'smicpoint';
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape.SmicPoint";
    }
    ...
    /**
     * @function Zondy.LevelRenderer.SmicPoint.prototype.buildPath
     * @description 创建点触。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicPoint.prototype.getRect
...
export {SmicPoint};
Zondy.LevelRenderer.SmicPoint = SmicPoint;