...
import {cloneObject} from '../../../service/common/Util'
import {Shape} from './Shape';
import {SUtil} from './SUtil';

/**
 * @private
 * @class  Zondy.LevelRenderer.SmicPolygon
 * @classdesc 多边形。
 * @extends Zondy.LevelRenderer.Shape
 * @example
 *   var shape = new Zondy.LevelRenderer.SmicPolygon({
 *         style: {
 *             // 100x100 的正方形
 ...
 *
 */
class SmicPolygon extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicPolygon.prototype.style
     * @description 绘制样式。
     *
     ...
     */
    /**
     * @function Zondy.LevelRenderer.SmicPolygon.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicPolygon.prototype.type
         * @description 图形类型.
         */
        this.type = 'smicpolygon';

        /**
         * @member {Array} Zondy.LevelRenderer.SmicPolygon.prototype._holePolygonPointList
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape.SmicPolygon";
    }

    /**
     * @function Zondy.LevelRenderer.SmicPolygon.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicPolygon.prototype.brush
     * @description 笔触。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicPolygon.prototype.buildPath
     * @description 创建多边形路径。
     *
     * @param {CanvasRenderingContext2D} ctx - Context2D 上下文。
    ...
    /**
     * @function Zondy.LevelRenderer.SmicPolygon.prototype.getRect
...
export {SmicPolygon};
Zondy.LevelRenderer.SmicPolygon = SmicPolygon;