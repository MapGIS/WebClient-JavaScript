...
class Area {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.constructor
     * @description 构造函数。
     */
    constructor() {
        /**
         * @member {Zondy.LevelRenderer.Tool.Util}  Zondy.LevelRenderer.Tool.Areal.prototype.util
         * @description 基础工具对象。
         */
        this.util = new Util();

        /**
         * @member {Zondy.LevelRenderer.Tool.Curve}  Zondy.LevelRenderer.Tool.Areal.prototype.curve
         * @description 曲线工具对象
         */
        this.curve = new LevelRendererCurve();

        /**
         * @member {Object} Zondy.LevelRenderer.Tool.Areal.prototype._ctx
         * @description Cavans2D 渲染上下文
         */
        this._ctx = null;

        /**
         * @member {Object} Zondy.LevelRenderer.Tool.Areal.prototype._textWidthCache
         * @description 文本宽度缓存
         */
        this._textWidthCache = {};

        /**
         * @member {Object} Zondy.LevelRenderer.Tool.Areal.prototype._textHeightCache
         * @description 文本高度缓存
         */
        this._textHeightCache = {};

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Areal.prototype._textWidthCacheCounter
         * @description 文本宽度缓存数量
         */
        this._textWidthCacheCounter = 0;

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Areal.prototype._textHeightCacheCounter
         * @description 文本高度缓存数量
         */
        this._textHeightCacheCounter = 0;

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Areal.prototype.TEXT_CACHE_MAX
         * @description 文本最大缓存数量
         */
        this.TEXT_CACHE_MAX = 5000;

        /**
         * @member {number} Zondy.LevelRenderer.Tool.Areal.prototype.PI2
         * @description 2*PI 的值
         */
        this.PI2 = Math.PI * 2;

        /**
         * @member {Array} Zondy.LevelRenderer.Tool.Areal.prototype.roots
         * @description 临时数组
         */
        this.roots = [-1, -1, -1];

        /**
         * @member {Array} Zondy.LevelRenderer.Tool.Areal.prototype.extrema
         * @description 临时数组
         */
        this.extrema = [-1, -1];
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.normalizeRadian
     * @description 弧度标准化函数。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInside
     * @description 包含判断。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype._mathMethod
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype._buildPathMethod
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isOutside
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideLine
     * @description 线段包含判断。
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideCubicStroke
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideQuadraticStroke
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideArcStroke
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideBrokenLine
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideRing
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideRect
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideCircle
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsideSector
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsidePolygon
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.windingLine
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.swapExtrema
     */
    swapExtrema() {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.windingCubic
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.windingQuadratic
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.windingArc
     * // TODO   Arc 旋转
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.isInsidePath
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.getTextWidth
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.Areal.prototype.getTextHeight
...
export {Area};
Zondy.LevelRenderer.Tool.Area = Area;