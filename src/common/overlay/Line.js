 ...
 * @property {Zondy.Feature.ShapeParameters.Point.style} [pointStyleByFields] - 按专题字段 themeFields（<Zondy.Layer.Graph.themeFields>）为折线节点赋 style，此参数按字段控制折线节点样式，
 *                       优先级低于 pointStyleByCodomain，高于 pointStyle。此数组中的元素是样式对象。
 *                       此参数中的 style 与 themeFields 中的字段一一对应 。例如： themeFields（<Zondy.Layer.Graph.themeFields|L.Zondy.graphThemeLayer.themeFields|ol.source.Graph.themeFields|mapboxgl.Zondy.GraphThemeLayer.themeFields>） 为 ["POP_1992", "POP_1995", "POP_1999"],
 ...
 * @property {Array.<Object>} pointStyleByCodomain - 按折线节点代表的数据值所在值域范围控制折线节点样式，优先级高于 pointStyle 和 pointStyleByFields。
