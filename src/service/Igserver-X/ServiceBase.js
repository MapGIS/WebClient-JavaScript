...
/**
 * @class module:IGServerX.IGServerXService
 * @description DataStore的基础服务
 * @author 基础平台-潘卓然
 */
export class IGServerXService extends ServiceBase {
    constructor(options) {
        super(options);
    ...
    /**
     * @function module:IGServerX.IGServerXService.prototype.getBaseUrl
    ...
    /**
     * @function module:IGServerX.IGServerXService.prototype.getFullUrl
     ...
     * @function module:IGServerX.IGServerXService.prototype.get
     ...
     * @function module:IGServerX.IGServerXService.prototype.post
     * @param  {String} url 完整的请求地址。
     * @param  {Function} onSuccess 查询成功回调函数。
     * @param {Function} onError 查询失败回调函数。
     */
...
export default IGServerXService;
