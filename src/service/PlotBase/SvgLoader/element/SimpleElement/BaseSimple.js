 ...
 * @LastEditors: zk
 * @LastEditTime: 2022-05-16 15:50:14
 */
...
export default class BaseSimple extends BasePlotElement {
  ...
  initBaseAttributes(node) {
     ...
     this.symbolName= this.getAttribute('zondyPlotSymbol:id').getValue()
     this.symbolDesc= this.getAttribute('zondyPlotSymbol:id').getValue()
  }
