...
// import './graphic';
 ...
 /**
  * @class mapboxgl.zondy.DeckglLayer
 ...
 export class DeckglLayer {
     constructor(layerTypeID, options) {
         ...
         /**
          * @member {string} mapboxgl.zondy.DeckglLayer.prototype.id
          * @description 高效率点图层 id。
          */
         this.layerTypeID = layerTypeID;
         /**
          * @member {Array.<mapboxgl.zondy.Graphic>} mapboxgl.zondy.DeckglLayer.prototype.graphics
          * @description 点要素对象数组。
          */
         ...
         this.id = options.layerId
             ? options.layerId
             : 'graphicLayer_' + this.layerTypeID + '_';
 
         /**
          * @member {boolean} [mapboxgl.zondy.DeckglLayer.prototype.visibility=true]
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.onAdd
      * @param {mapboxgl.Map} map - Mapbox GL 地图对象。
      * @returns {mapboxgl.zondy.DeckglLayer}
      */
     onAdd(map) {
         this.map = map;
         if (this.canvas) {
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.remove
      * @description 删除该图层。
      */
     remove() {
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.removeFromMap
      * @deprecated
      * @description 删除该图层。
      */
     removeFromMap() {
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.moveTo
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.setVisibility
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.setStyle
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.setData
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.addData
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.update
      * @description 更新图层。
      */
     update() {
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.clear
      * @description 释放图层资源。
      */
     // todo 还有哪些资源应该被释放？
     clear() {
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype.removeData
      * @description 移除所有要素。
      */
     removeData() {
         this.data.length = 0;
     ...
     /**
      * @function mapboxgl.zondy.DeckglLayer.prototype._createLayerByLayerTypeID
 ...
 mapboxgl.zondy.DeckglLayer = DeckglLayer;
