...
class Clip {
    ...
    /**
     * @function Zondy.LevelRenderer.Animation.Clip.prototype.constructor
     * @description 构造函数。
    ...
    /**
     * @function Zondy.LevelRenderer.Animation.Clip.prototype.destroy
...
export {Clip};
Zondy.LevelRenderer.Animation.Clip = Clip;