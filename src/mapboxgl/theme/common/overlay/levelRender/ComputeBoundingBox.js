...
class ComputeBoundingBox {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.ComputeBoundingBox.prototype.constructor
     * @description 构造函数。
     */
    constructor() {
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.ComputeBoundingBox.prototype.computeBoundingBox
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.ComputeBoundingBox.prototype.cubeBezier
    ...
    cubeBezier(p0, p1, p2, p3, min, max) {
        var curve = new LevelRendererCurve();
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.ComputeBoundingBox.prototype.quadraticBezier
    ...
    /**
     * @function Zondy.LevelRenderer.Tool.ComputeBoundingBox.prototype.arc
    ...
    arc(x, y, r, startAngle, endAngle, anticlockwise, min, max) {
        var vec2 = new LevelRendererVector();
...
Zondy.LevelRenderer.Tool.ComputeBoundingBox = ComputeBoundingBox;