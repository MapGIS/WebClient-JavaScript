...
const { Zondy, mixin, newGuid, extend } = Common;
 ...
 */
class Shape extends mixin(Eventful, Transformable) {

    /**
     * @function Zondy.LevelRenderer.Shape.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        ...
        options = options || {};
        /**
         * @member {string} Zondy.LevelRenderer.Shape.prototype.id
         * @description 唯一标识。
         */
        this.id = null;

        /**
         * @member {Object} Zondy.LevelRenderer.Shape.prototype.style
         * @description 基础绘制样式。
        ...
        /**
         * @member {Object} Zondy.LevelRenderer.Shape.prototype.style.__rect
        ...
        /**
         * @member {Object} Zondy.LevelRenderer.Shape.prototype.highlightStyle
         * @description 高亮样式。
         *
        ...
        /**
         * @member {Object} Zondy.LevelRenderer.Shape.prototype.parent
         * @description 父节点，只读属性。<Zondy.LevelRenderer.Group>
         */
        this.parent = null;

        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.__dirty
         * @description {boolean}
         */
        this.__dirty = true;

        /**
         * @member {Array} Zondy.LevelRenderer.Shape.prototype.__clipShapes
         * @description {Array}
         *
         */
        this.__clipShapes = [];
        ...
        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.invisible
         * @description 图形是否可见，为 true 时不绘制图形，但是仍能触发鼠标事件。默认值：false。
         */
        this.invisible = false;

        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.ignore
         * @description 图形是否忽略，为 true 时忽略图形的绘制以及事件触发。默认值：false。
         */
        this.ignore = false;

        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.zlevel
         * @description z 层 level，决定绘画在哪层 canvas 中。默认值：0。
         */
        this.zlevel = 0;

        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.draggable
         * @description 是否可拖拽。默认值：false。
         */
        this.draggable = false;

        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.clickable
         * @description 是否可点击。默认值：false。
         */
        this.clickable = false;

        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.hoverable
         * @description 是否可以 hover。默认值：true。
         */
        this.hoverable = true;

        /**
         * @member {number} Zondy.LevelRenderer.Shape.prototype.z
        ...
        //地理扩展
        /**
         * @member {Array} Zondy.LevelRenderer.Shape.prototype.refOriginalPosition
        ...
        /**
         * @member {string} Zondy.LevelRenderer.Shape.prototype.refDataID
        ...
        /**
         * @member {boolean} Zondy.LevelRenderer.Shape.prototype.isHoverByRefDataID
        ...
        /**
         *  @member {string} Zondy.LevelRenderer.Shape.prototype.refDataHoverGroup
        ...
        /**
         * @member {Object} Zondy.LevelRenderer.Shape.prototype.dataInfo
         * @description 图形的数据信息。
         *
         */
        this.dataInfo = null;
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape";
        /**
         * @function Zondy.LevelRenderer.Shape.prototype.getTansform
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.beforeBrush
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.afterBrush
     * @description 绘制后的处理。
     *
     * @param {CanvasRenderingContext2D} ctx - Context2D 上下文。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.setContext
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.doClip
     *
     */
    doClip(ctx) {
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.getHighlightStyle
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.getHighlightZoom
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.drift
     * @description 移动位置
     *
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.buildPath
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.getRect
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.isCover
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.drawText
     * @description 绘制附加文本。
     *
     * @param {CanvasRenderingContext2D} ctx - Context2D 上下文。
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.modSelf
     * @description 图形发生改变
     */
    modSelf() {
        this.__dirty = true;
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.isSilent
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype.setCtxGlobalAlpha
    ...
    /**
     * @function Zondy.LevelRenderer.Shape.prototype._fillText
     * @description 填充文本
     */
    ...
    /**
     * @function Zondy.LevelRenderer.Shape._getTextRect
...
export {Shape};
Zondy.LevelRenderer.Shape = Shape;
