...
/**
 * @private
 * @class  Zondy.LevelRenderer.SmicSector
 * @classdesc 扇形。
 * @extends Zondy.LevelRenderer.Shape
 * @example
 *   var shape = new Zondy.LevelRenderer.SmicSector({
 *         style: {
 *             x: 100,
 *             y: 100,
 *             r: 60,
 ...
 */
class SmicSector extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicSector.prototype.style
     * @description 绘制样式。
     *
     ...
     */
    /**
     * @function Zondy.LevelRenderer.SmicSector.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Zondy.LevelRenderer.SmicSector.protptype.type
         * @description 图形类型。
         */
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape.SmicSector";
    }

    /**
     * @function Zondy.LevelRenderer.SmicSector.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicSector.prototype.buildPath
     * @description 创建扇形路径。
     *
    ...
    /**
     * @function Zondy.LevelRenderer.SmicSector.prototype.getRect
...
export {SmicSector};
Zondy.LevelRenderer.SmicSector = SmicSector;