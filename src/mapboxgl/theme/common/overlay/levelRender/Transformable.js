...
class Transformable {
    ...
    /**
     * @function Zondy.LevelRenderer.Transformable.constructor
     * @description 构造函数。
     */
    constructor() {
        /**
         * @member {Array.<number>} Zondy.LevelRenderer.Transformable.prototype.position
         * @description 平移， 默认值：[0, 0]。
         */
        this.position = [0, 0];

        /**
         * @member {Array.<number>} Zondy.LevelRenderer.Transformable.prototype.rotation
         * @description 旋转，可以通过数组二三项指定旋转的原点， 默认值：[0, 0, 0]。
         */
        this.rotation = [0, 0, 0];

        /**
         * @member {Array.<number>} Zondy.LevelRenderer.Transformable.prototype.scale
         * @description 缩放，可以通过数组三四项指定缩放的原点， 默认值：[1, 1, 0, 0]。
         */
        this.scale = [1, 1, 0, 0];

        /**
         * @member {boolean} Zondy.LevelRenderer.Transformable.prototype.needLocalTransform
         * @description 是否变换。默认值：false。
         */
        this.needLocalTransform = false;

        /**
         * @member {boolean} Zondy.LevelRenderer.Transformable.prototype.needTransform
        ...
        /**
         * @function Zondy.LevelRenderer.Transformable.prototype.lookAt
         * @description 设置图形的朝向。
         */
    ...
    /**
     * @function Zondy.LevelRenderer.Transformable.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.Transformable.prototype.updateNeedTransform
    ...
    /**
     * @function Zondy.LevelRenderer.Transformable.prototype.updateTransform
    ...
    /**
     * @function Zondy.LevelRenderer.Transformable.prototype.setTransform
    ...
    /**
     * @function Zondy.LevelRenderer.Transformable.prototype.decomposeTransform
...
Zondy.LevelRenderer.Transformable = Transformable;