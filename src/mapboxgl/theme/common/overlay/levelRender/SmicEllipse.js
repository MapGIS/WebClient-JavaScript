...
/**
 * @private
 * @class  Zondy.LevelRenderer.SmicEllipse
 * @classdesc 椭圆。
 * @extends Zondy.LevelRenderer.Shape
 * @example
 *   var shape = new Zondy.LevelRenderer.SmicEllipse({
 *       style: {
 *           x: 100,
 *           y: 100,
 *           a: 40,
 ...
 */
class SmicEllipse extends Shape {

    /**
     * @member {Object} Zondy.LevelRenderer.SmicEllipse.style
     * @description 绘制样式。
     *
     ...
     */
    /**
     * @function Zondy.LevelRenderer.SmicEllipse.constructor
     * @description 构造函数。
     *
    ...
    constructor(options) {
        ...
        /**
         * @member {string} Zondy.LevelRenderer.SmicEllipse.prototype.type
         * @description 图形类型。
         */
        ...
        this.CLASS_NAME = "Zondy.LevelRenderer.Shape.SmicEllipse";
    }

    /**
     * @function Zondy.LevelRenderer.SmicEllipse.prototype.destroy
    ...
    /**
     * @function Zondy.LevelRenderer.SmicEllipse.prototype.buildPath
    ...
    /**
     * @function Zondy.LevelRenderer.SmicEllipse.prototype.getRect
...
export {SmicEllipse};
Zondy.LevelRenderer.SmicEllipse = SmicEllipse;