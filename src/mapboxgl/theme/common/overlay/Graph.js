 ...
 *              统计专题要素模型采用了可视化图形大小自适应策略，用较少的参数控制着图表诸多图形，图表配置对象 <Zondy.Theme.Graph.setting> 的基础属性只有 7 个，
...
class Graph extends Theme {
    ...
    constructor(data, layer, fields, setting, lonlat, options) {
         ...
         * @description 当前图形参数对象，<Zondy.ShapeParameters> 的子类对象。
         */
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.origonPoint
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.chartBox
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.DVBParameter
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.dataViewBox
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.DVBCodomain
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.DVBCenterPoint
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.DVBOrigonPoint
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.origonPointOffset
        ...
        /**
         * @readonly
         * @member {Array.<string>} Zondy.Theme.Graph.prototype.fields
        ...
        /**
         * @readonly
         * @member {Array.<number>} Zondy.Theme.Graph.prototype.dataValues
