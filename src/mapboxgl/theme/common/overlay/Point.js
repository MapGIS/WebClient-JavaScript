 ...
 * @property {Array.<Zondy.Feature.ShapeParameters.Point.style>} [pointStyleByFields] - 按专题字段 themeFields（<Zondy.Layer.Graph.themeFields>）为图形点赋 style，此参数按字段控制图形点样式，
...
class Point extends Graph {
    ...
    constructor(data, layer, fields, setting, lonlat, options) {
        ...
        this.CLASS_NAME = "Zondy.Theme.Point";
    }

    /**
     * @function Zondy.Theme.Point.prototype.destroy
    ...
    /**
     * @function Zondy.Theme.Point.prototype.assembleShapes
    ...
    /**
     * @function Zondy.Theme.Point.prototype.calculateXShapeInfo
