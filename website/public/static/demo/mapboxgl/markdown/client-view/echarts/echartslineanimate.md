...
在北京市范围内的地图上北京公交路线数据，展示大数据量的动态地图可视化效果。
...
4. 加载公交路线数据，通过mapboxgl扩展的EchartsLayer图层实现，其中的参数option与<a target="_blank" href="http://echarts.baidu.com/api.html#echarts">echarts</a>方法`setOption`中一致；
