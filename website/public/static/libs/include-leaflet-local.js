(function () {
  ...
  function load() {
    ...
    if (inArray(includes, 'cluster')) {
      inputCSS(httpUrl + "/cdn/leaflet-plugins/Leaflet.markercluster-1.4.1/dist/MarkerCluster.css");
      inputCSS(httpUrl + "/cdn/leaflet-plugins/Leaflet.markercluster-1.4.1/dist/MarkerCluster.Default.css");
      inputScript(httpUrl + "/cdn/leaflet-plugins/Leaflet.markercluster-1.4.1/dist/leaflet.markercluster.js");
    }
