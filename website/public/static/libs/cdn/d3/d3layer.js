...
(function (factory) {
    ...
    L.D3SvgOverlay = (L.version < "1.0" ? L.Class : L.Layer).extend({
        ...
        //重绘函数，根据新的drawCallback中的selection进行重绘操作
        redraw: function (drawCallback) {
        ...
        onAdd: function (map) {
            ...
            if (L.version < "1.0") {
                ...
                this._svg = L.svg(); //正如https://leafletjs.com/reference-1.3.0.html#svg 描述的一样，svg作为渲染器来渲染矢量图形
                this.indexlayer = map.addLayer(this._svg);
                //对匹配的元素还为添加这个class名的元素添加这个class名字为d3-overlay
            ...
            //latLngToLayerPoint  给定地理坐标，返回相对于原点像素的相应像素坐标。
            ...
            this.projection._projectPoint = function (x, y) {
                ...
                this.stream.point(point.x, point.y); //d3.stream.point(x, y)
            };
        ...
        bringToFront: function () {
            var layer = this;
            /* this._svg._bringToFront(layer);  */
        },

        bringToBack: function () {
            var _layer = this;
            /* this._svg._bringToBack(_layer); */
        }
    ...
    L.zondy = L.zondy || {};
    // Factory method
    L.zondy.d3SvgOverlay = function (drawCallback, options) {
