(function () {
  ...
  function load() {
    ...
    if (!inArray(excludes, 'leaflet')) {
      /* inputCSS(local + "/cdn/leaflet/leaflet.css");
      inputScript(local + "/cdn/zondyclient/webclient-leaflet-framework.min.js"); */
      if (onInternetMode) {
        /* inputCSS('https://unpkg.com/leaflet@1.3.1/dist/leaflet.css');
        inputScript('https://unpkg.com/leaflet@1.3.1/dist/leaflet.js'); */
    ...
    if (inArray(includes, 'json')) {
      /* inputScript(local + "/cdn/json/jsonExtend.js"); */
      if (onInternetMode) {
...
/*       inputScript(local + "/cdn/proj4/proj4.js");
      inputScript(local + "/cdn/leaflet-plugins/Proj4Leaflet/lib/proj4-compressed.js");
      inputScript(local + "/cdn/leaflet-plugins/Proj4Leaflet/src/proj4leaflet.js"); */
    ...
    if (inArray(includes, 'd3')) {
      /* inputScript(local + "/cdn/d3/d3.min.js");
      inputScript(local + "/cdn/d3/d3-hexbin.min.js");
      inputScript(local + "/cdn/d3/d3layer.js"); */
      if (onInternetMode) {
